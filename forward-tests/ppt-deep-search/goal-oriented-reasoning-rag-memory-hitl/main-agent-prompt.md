...
- `forward-tests/ppt-deep-search/goal-oriented-reasoning-rag-memory-hitl/candidate/input/pdf_xml/final/Goal-Oriented Reasoning for RAG-based Memory in Conversational Agentic LLM Systems.xml`
- `forward-tests/ppt-deep-search/goal-oriented-reasoning-rag-memory-hitl/candidate/input/pdf_xml/final/images/`
- `forward-tests/ppt-deep-search/goal-oriented-reasoning-rag-memory-hitl/candidate/input/pdf_xml/Goal-Oriented Reasoning for RAG-based Memory in Conversational Agentic LLM Systems.intermediate_parse_results.zip`
...
- Candidate Prompt: forward-tests/ppt-deep-search/goal-oriented-reasoning-rag-memory-hitl/candidate/prompt.md
- Candidate Input: forward-tests/ppt-deep-search/goal-oriented-reasoning-rag-memory-hitl/candidate/input/

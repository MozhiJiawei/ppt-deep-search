...
- For webpage sources, Codex Browser/browser-use evidence package locators: rendered article text, structured article JSON, image index, local source-image paths, screenshots, selected content container, capture time, and excluded page regions.
